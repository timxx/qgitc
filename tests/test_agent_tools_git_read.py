...
class TestGitLogTool(unittest.TestCase):
    ...
    def test_inputSchema_structure(self):
    ...
    @patch("qgitc.agent.tools.git_log.runGit")
...
class TestGitDiffTool(unittest.TestCase):
    ...
    def test_inputSchema_requires_rev(self):
        schema = self.tool.inputSchema()
    ...
    @patch("qgitc.agent.tools.git_diff.runGit")
...
class TestGitDiffUnstagedTool(unittest.TestCase):
    ...
    @patch("qgitc.agent.tools.git_diff_unstaged.runGit")
...
class TestGitDiffStagedTool(unittest.TestCase):
    ...
    @patch("qgitc.agent.tools.git_diff_staged.runGit")
    def test_full_diff(self, mock_run):
        mock_run.return_value = (True, "diff output")
        result = self.tool.execute({}, _ctx())
        self.assertFalse(result.is_error)
...
class TestGitDiffRangeTool(unittest.TestCase):
    ...
    @patch("qgitc.agent.tools.git_diff_range.runGit")
